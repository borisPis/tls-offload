...
insmod: module
	...
	sudo rmmod af_ktls_offload.ko af_ktls.ko 2>/dev/null; sudo insmod af_ktls.ko; sudo insmod af_ktls_offload.ko

rmmod:
	sudo rmmod af_ktls_offload.ko af_ktls.ko
